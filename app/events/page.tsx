    ...
    <div className="container mx-auto px-4 py-8">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Join us for exciting community events that celebrate Telugu culture and bring our youth together
        </p>
      </div>
              ...
              {pastEvents.map((event) => (
                <Card key={event.id} className="group hover:shadow-lg transition-all duration-300 cursor-pointer pt-0 overflow-hidden">
                  ...
                  <CardContent className="p-6 pt-0">
                    ...
                    <Link href={`/events/${event.slug}`}>
                      <Button variant="outline" className="w-full group-hover:translate-y-0 transition-transform">
